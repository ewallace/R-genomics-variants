---
title: "Data Analysis and Visualization in R for Genomics"
author: Edward Wallace, François Michonneau & Auriel Fournier (Lesson Maintainers)
---
...
3. [Data visualization with **`ggplot2`**](02-visualizing-ggplot.html)
4. [Starting with data](03-starting-with-data.html)
...
Data files for the lesson are available and included in this github in the data directory (https://github.com/ewallace/R-genomics-variants/data).

They can also be downloaded manually from here:

https://datasync.ed.ac.uk/index.php/s/joLsSXedpyaABHe

password: genomics-carpentry
